...
export const AuthView: React.FC<AuthViewProps> = ({
  ...
  return (
    <div dir="rtl" className="w-full min-h-[75vh] flex flex-col items-center justify-center px-4 py-8 animate-fadeIn font-vazir">
      {/* Clean without border, shadow or card background */}
